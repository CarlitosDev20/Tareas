const actas_bscarPrNmroMesa = async(form) => {
    ...
    const mesa = document.getElementById('nroMesa').value.trim()
    const data = await fetch(`https://oaemdl.es/onpe_sweb_php/actas/numero/${mesa}`)
    
    if(data.status == 200 ){
        let nromesa = await data.json()
        nromesa = nromesa.data
                                      ...
                                      <div class="col-xs-12">
                                        ...
                                        <div id="page-wrap">
                                          <table class="table13" cellspacing="0">
                                            ...
                                            <tbody>
                                              <tr>
                                                <td>${nromesa.idGrupoVotacion}</td>
                                                <td>${nromesa.nCopia}</td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </div>
                                        ...
                                        <div id="page-wrap">
                                          <table class="table14" cellspacing="0">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td>${nromesa.Departamento}</td>
                                                <td>${nromesa.Provincia}</td>
                                                <td>${nromesa.Distrito}</td>
                                                <td>${nromesa.RazonSocial}</td>
                                                <td>${nromesa.Direccion}</td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </div>
                                        ...
                                        <div id="page-wrap">
                                          <table class="table15" cellspacing="0">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td>${nromesa.ElectoresHabiles}</td>
                                                <td>${nromesa.TotalVotantes}</td>
                                      ...
                                      <table class="table06">
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>${nromesa.VotosBlancos}</td>
                                          </tr>
                                          <tr>
                                            <td colspan="2">VOTOS NULOS</td>
                                            <td>${nromesa.VotosNulos}</td>
                                          </tr>
                                          <tr>
                                            <td colspan="2">VOTOS IMPUGNADOS</td>
                                            <td>${nromesa.VotosImpugnados}</td>
                                          </tr>
                                          <tr>
